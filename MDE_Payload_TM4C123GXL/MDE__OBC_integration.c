//*****************************************************************************
//
// The MDE payload prototype for Integreation with OBC
// THis versoin has no scienctific functionality, focuses on uart communication
...
print_menu(void)
{
  ...
  case MAIN:
    ...
    UARTSend((uint8_t*) buf, strlen(buf));
    sprintf(buf, "H - Send and print Health Packet (TransmitHealth) \n\r");
    UARTSend((uint8_t*) buf, strlen(buf));
    sprintf(buf, "D - Send and print Data Packet (TransmitErrors) \n\r");
    UARTSend((uint8_t*) buf, strlen(buf));
    break;
  case AUTO:
...
//*****************************************************************************
//
// MAIN: Prototype for developing and testing integreation with OBC
//
//*****************************************************************************
int main(void){
